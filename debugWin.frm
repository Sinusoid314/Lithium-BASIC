...
mainCode.RunCmd Trim(runtimeCmd.Text)
...
For a = 1 To debugCode.Item(stack.ListIndex + 1).runCode.itemCount
    codeWin.code.AddItem debugCode.Item(stack.ListIndex + 1).runCode.Item(a)
Next a

codeWin.code.ListIndex = debugLneSel.Item(stack.ListIndex + 1)
